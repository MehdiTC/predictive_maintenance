...
DEMO_WARNING_HORIZON = 50
DEMO_CRITICAL_HORIZON = 30

# Generated by the reproducible held-out replay evaluation and published in
# docs/model_card.md. Keep this compact projection aligned with that report.
DEMO_EVIDENCE = DemoEvidenceResponse(
...
class DashboardService:
    ...
    def demo(self) -> DemoStateResponse:
        ...
        return DemoStateResponse(
            ...
            warning_horizon=DEMO_WARNING_HORIZON,
            critical_horizon=DEMO_CRITICAL_HORIZON,
